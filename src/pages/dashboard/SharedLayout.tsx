...
const SharedLayout = () => {
  return (
    <main className="h-screen md:w-full lg:max-w-screen-2xl lg:center-div-lg bg-gray-200 flex flex-col overflow-y-hidden">
      <div className="pt-10 flex-end justify-start">
        <SearchBar />
      </div>
      {/* container */}
...
{/* Navbar for mobile version */}
      <div className="md:hidden mx-5 flex items-center py-3 mt-10 bg-white rounded-md shadow-sm shadow-white mb-3 justify-end">
        <Navbar />
      </div>      
    </main>
  )
