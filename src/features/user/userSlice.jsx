...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    toggleFriendsModal: (state) => {
      state.openFriendsModal = !state.openFriendsModal;
    },
    closeFriendsModal: (state) => {
      state.openFriendsModal = false;
    },
    openSearchUserModalMobile: (state) => {
      state.searchUserModalMobile = !state.searchUserModalMobile;
    },
    closeSearchUserModalMobile: (state) => {
      state.searchUserModalMobile = false;
    },
  },
  extraReducers: (builder) => {
    builder
      ...
      .addCase(uploadImage.pending, (state) => {
        state.isLoadingProfilePicture = true;
      })
...
export const { toggleSidebar, toggleOpenModal, toggleLogout, openSearchUserModal, closeSearchUserModal, toggleFriendsModal, closeFriendsModal, openSearchUserModalMobile, closeSearchUserModalMobile } = userSlice.actions;
